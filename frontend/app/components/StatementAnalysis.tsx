            ...
            <div className="p-4">
              <div className="bg-zinc-900/80 rounded-3xl p-8 border-2 border-purple-600/60 shadow-lg max-w-md mx-auto">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-[#5f259f]/80 rounded-full flex items-center justify-center shadow-md">
                  ...
                  <p className="text-zinc-300 text-base mb-6">Drag and drop your <span className="text-[#5f259f] font-semibold">PhonePe PDF statement</span> here, or click to browse.</p>
                  <div
                  ...
                  >
                    ...
                    />
                    <ArrowUpTrayIcon className="w-8 h-8 text-[#5f259f] mx-auto mb-3" />
                    <button
                      type="button"
                      className="mt-2 px-6 py-3 bg-[#5f259f] text-white rounded-lg font-semibold hover:bg-purple-700 transition-colors"
                      onClick={() => document.getElementById('fileInput')?.click()}
                    >
                      Select the PDF file
                    </button>
